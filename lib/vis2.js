    ...
    legend.append("text")
        ...
        const radius = 160;
          ...
          piechart = function(piedata, year) {
            ...
            .append("g")
            .attr("transform", "translate(190,270)")
            
            pieChartSvg.append("text").attr("id","title").text("MOSQUITO SPECIES").attr("transform", "translate(-150,-230)")
       ...
       // console.log(colorDomain)
        ...
        const urlList = ([{url: "https://raw.githubusercontent.com/mshea12/week7-568/main/USMosq.png"},
