Promise.all([d3.csv("https://raw.githubusercontent.com/mshea12/week7-568/main/Mosq_Type_By_Year.csv", d3.autoType),
    ...
    barChartSvg.append("text").attr("id","title").text("MOSQUITO GENUS").attr("transform", "translate(100,20)")
    ...
    legend.append("text")
        ...
        const radius = 160;
          ...
          piechart = function(piedata, year) {
            ...
            pieChartSvg.append("text").attr("id","title").text("MOSQUITO SPECIES").attr("transform", "translate(-170,-220)")
        ...
        colorDomain = d3.map(data2, function (d) {return d.Species}).keys()
        ...
        //slicePercentage = pie(data2).foreach(function(d){ d.percentage = d.Num/totals})
    ...
    }).style("text-anchor", "middle").attr("dy", ".35em").text(function(d) {return d.data.Num})
